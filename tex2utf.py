"""TeX accent / symbol escapes -> Unicode, as arXiv itself renders them.

Vendored verbatim (apart from this header) from arxiv-base 0.17.8,
arxiv/util/tex2utf.py, Copyright 2017 Cornell University, MIT licence
(https://github.com/arXiv/arxiv-base). The OAI-PMH arXivRaw format hands
out titles, abstracts and author lines as submitted, TeX escapes included,
whereas the old Atom API applied this same conversion before serving them;
running it here keeps the cached JSON and the site identical across the
two sources.
"""
import re
